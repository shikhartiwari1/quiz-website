...
text = """1. Consumer behaviour primarily helps marketers understand how buyers _________ among the competing brands.
...
for line in lines:
    ...
    if line.endswith('–20') or line.endswith('–30') or line.endswith('–40') or line.endswith('–50') or line.endswith('–60') or line.endswith('–70') or line.endswith('–80'):
        continue
    
    # Check if line is a question start (e.g., "1. ")
    if len(line) > 0 and line[0].isdigit() and '. ' in line[:5]:
        ...
        if current_q:
            current_q['answer'] = line.replace('Answer: ', '')

if current_q:
    questions.append(current_q)

import sys
with open('c:/Users/SHIKHAR TIWARI/Desktop/quiz/questions.json', 'w', encoding='utf-8') as f:
